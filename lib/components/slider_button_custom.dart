...
class SliderButtonCustom extends StatefulWidget {
  ...
  @override
  _SliderButtonCustomState createState() => _SliderButtonCustomState();
}

class _SliderButtonCustomState extends State<SliderButtonCustom> {
  bool flag;
